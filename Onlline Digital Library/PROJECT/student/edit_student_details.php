                    ...
                    <div class="span9">
                        <div class="module">
                            ...
                            <div class="module-body">
                                ...
                                $sql="select * from LMS.user where UserName='$username'";
                                ...
                                <form class="form-horizontal row-fluid" action="edit_student_details.php?id=<?php echo $username ?>" method="post">
                                    ...
                                    <div class="control-group">
                                            <label class="control-label" for="Category"><b>Branch:</b></label>
                                            <div class="controls">
                                                <select name = "Branch" tabindex="1" value="SC" data-placeholder="Select Branch" class="span6">
...
$sql1="update LMS.user set Name='$name', Branch='$branch', EmailId='$email', MobNo='$mobno', Password='$pswd' where UserName='$username'";
