                ...
                <div class="row">
                    ...
                    <div class="span9">
                        ...
                        <table class="table" id = "tables">
                                  ...
                                  <tbody>
                                    <?php
                            $sql="select * from LMS.record,LMS.book,LMS.renew where renew.BookId=book.BookId and renew.UserName=record.UserName and renew.BookId=record.BookId";
                            ...
                            ?>
                                    <tr>
                                      ...
                                      <td><center>
                                        <?php
                                        if($renewals > 0)
                                        {echo "<a href=\"acceptrenewal.php?id1=".$bookid."&id2=".$username."\" class=\"btn btn-success\">Accept</a>";}
                                         ?>
