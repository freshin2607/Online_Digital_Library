...
<head>
	...
	<!-- Meta-Tags -->
		...
		<meta name="keywords" content="Library Member Login Form" />
...
<body>
	...
	<div class="footer w3layouts agileits">
		<p> &copy; 2020 Digital Library. All Rights Reserved </a></p>
	</div>
...
if(isset($_POST['signup']))
{
	...
	$sql="insert into LMS.user (Name,Type,Branch,UserName,EmailId,MobNo,Password) values ('$name','$type','$branch','$username','$email','$mobno','$password')";
