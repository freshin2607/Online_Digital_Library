                            ...
                            <div class="module-body">
                                    ...
                                    <form class="form-horizontal row-fluid" action="message.php" method="post">
                                        <div class="control-group">
                                            <label class="control-label" for="UserName"><b>Receiver UserName:</b></label>
                                            <div class="controls">
...
$sql1="insert into LMS.message (UserName,Msg,Date,Time) values ('$username','$message',curdate(),curtime())";
