                ...
                <div class="row">
                    ...
                    <div class="span9">
                        ...
                        <table class="table" id = "tables">
                                  ...
                                  <tbody>
                                    <?php
                            $sql="select return.BookId,return.UserName,Title,datediff(curdate(),Due_Date) as x from LMS.return,LMS.book,LMS.record where return.BookId=book.BookId and return.BookId=record.BookId and return.UserName=record.UserName";
                            ...
                            ?>
                                    <tr>
                                      ...
                                      <td><center>
                                        ...
                                        <a href="acceptreturn.php?id1=<?php echo $bookid; ?>&id2=<?php echo $username; ?>&id3=<?php echo $dues ?>" class="btn btn-success">Accept</a>
